...
app.controller('DriverController', ['$scope', '$http', function ($scope, $http) {
    ...
    $scope.addDriver = function () {
        alert($scope.driver.nameDriver);
        $scope.driver.birthDriver = strtotime($scope.driver.birthDriver );
        $scope.driver.birthDriver  = date('Y-m-d', $scope.driver.birthDriver);
        alert($scope.driver.birthDriver);
        alert($scope.driver.cpfDriver);
        alert($scope.driver.carDriver);
        alert($scope.driver.statusDriver);
        alert($scope.driver.genderDriver);
